class BankAccounts // super parent for common data+methods
{
    ...
    BankAccounts() { //user defined explicit no-arg ctor | NOT A DEFAULT ONE
		System.out.println("BankAccount ctor....");
	}

	/* void set */BankAccounts(int num, String holder, double bal) {
...
public class SyncTest {
	...
	public static void main(String[] args) {
		BankAccounts ba = new BankAccounts(101,"Julie",50000);
		ba.showBankAccount();
...
class Teller extends Thread //1
{
	...
	Teller(String tn, BankAccounts x, double amt) {
		tellerName = tn;
		bankRef = x;
		amountToDeposit=amt;
	}
